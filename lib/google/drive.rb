...
module Google
  class Drive
    def self.spreadsheet(google_sheet_id: "1okgAXtvc_3pm8fyNUZS0UKO2KkE7NTGw5vPBdTbzlLg", worksheet: )
      ...
      session.spreadsheet_by_key(google_sheet_id).worksheets[worksheet]
    end
  end
end
