...
class Lines::UserBot::Services::CustomersController < Lines::UserBotDashboardController
  def index
    ...
    @relations = @online_service.online_service_customer_relations.includes(:customer, :last_customer_payment).order("online_service_customer_relations.created_at DESC")
