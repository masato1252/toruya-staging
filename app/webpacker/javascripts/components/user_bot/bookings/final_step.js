...
import { BookingPageUrlCopyBtn, BookingPageButtonCopyBtn } from "shared/components";
...
const FinalStep = ({step}) => {
  ...
  return (
    <div className="booking-creation-flow centerize">
      ...
      <BookingPageUrlCopyBtn booking_page_url={Routes.booking_page_url(booking_page_id || 0)} />
