...
import WorkingTimeBusinessScheduleForm from "./business_schedules_form.js";
import CustomSchedules from "../schedules/custom_schedules.js";

class WorkingTimeStaffForm extends React.Component {
  state = {
                ...
                <div id="tempHoliday" className="formRow" key={`shop-${shop.id}-schedule-setting`}>
                  {
                    this.props.regularWorkingTimePermission ? (
                      <div>
                        ...
                        {
                          this.state.scheduleDisplaying[`business_schedules_${shop.id}`] ? (
                            <WorkingTimeBusinessScheduleForm
...
export default WorkingTimeStaffForm;
