...
class User < ApplicationRecord
  ...
  delegate :line_keyword_booking_page_ids, :line_keyword_booking_option_ids, :line_contact_customer_name_required, :customer_tags, :toruya_message_reply, to: :user_setting
