...
module CustomMessages
  module Customers
    class Template < ActiveInteraction::Base
      ...
      SCENARIOS = [ONLINE_SERVICE_PURCHASED, ONLINE_SERVICE_MESSAGE_TEMPLATE, BOOKING_PAGE_BOOKED, RESERVATION_CONFIRMED, BOOKING_PAGE_ONE_DAY_REMINDER, RESERVATION_ONE_DAY_REMINDER, BOOKING_PAGE_CUSTOM_REMINDER, LESSON_WATCHED, EPISODE_WATCHED].freeze
