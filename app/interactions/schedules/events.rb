class Schedules::Events < ActiveInteraction::Base
  ...
  def execute
    ...
    if month_date
      ...
      booking_page_holder_schedules = booking_page_holder_schedules.where("start_at >= ? and end_at <= ?", month_date.beginning_of_month, month_date.end_of_month.end_of_day)
