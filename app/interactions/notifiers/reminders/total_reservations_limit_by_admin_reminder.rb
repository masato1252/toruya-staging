module Notifiers
  module Reminders
    class TotalReservationsLimitByAdminReminder < Base
      deliver_by_priority [:line, :sms, :email], mailer: ReminderMailer, mailer_method: :total_reservations_limit_by_admin_reminder

      def message
        I18n.t(
          "notifier.reminders.total_reservations_limit_by_admin_reminder.message",
          user_name: user.name,
