    ...
    class CloseCustomersLimit < Base
      ...
      def message
        if receiver.subscription.plan.free_level?
          I18n.t("notifier.reminders.free_plan_close_customers_limit.message", user_name: receiver.name, max_customers_limit: Plan.max_customers_limit(Plan::FREE_PLAN, 0))
        else
