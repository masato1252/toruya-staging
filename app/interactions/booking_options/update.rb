module BookingOptions
  class Update < ActiveInteraction::Base
    ...
    hash :attrs, default: nil do
      ...
      # menus array hash
      # [
      #   { "label" => "menu_name", "value" => "menu_id", "priority" => 0, "required_time" => 100 },
      #   { "label" => "ANAT002筋骨BODY", "value" => "6", "priority" => 1, "required_time" => 200 }
      # [
      # array :menus, default: nil, strip: false
    end
    ...
    def execute
      ...
      booking_option.with_lock do
        ...
        when "new_menu"
          # TODO: Add script: BookingOptionMenu.where(priority: nil).update_all(priority: 0)
          booking_option.booking_option_menus.create(
            menu_id: attrs["new_menu"],
