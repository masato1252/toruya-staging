      ...
      def execute
        ...
        unless relation.purchased?
          ...
          if sale_page.free?
            ...
            message_content = custom_message_content || I18n.t("online_service_purchases.free_service.purchased_notification_message", service_title: sale_page.product.name)
          else
