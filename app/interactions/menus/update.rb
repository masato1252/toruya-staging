  ...
  class Update < ActiveInteraction::Base
    ...
    def execute
      ApplicationRecord.transaction do
        ...
        shop_menus_attributes = attrs.delete(:shop_menus_attributes)
        ...
        menu.shop_menus.delete_all
        menu.shop_menus.build(shop_menus_attributes.select{ |attribute| attribute["shop_id"].present? })
