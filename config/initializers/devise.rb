...
Devise.setup do |config|
  ...
  # config.secret_key = '8a0a59e0177abf86546476e74977a97841a8c80205077736e98340c9dd6f56efe586f0ce622bbe40cf2930642df5653c3e316318b3ba89069d63ddac6ec63f74'

  # ==> Mailer Configuration
  # Configure the e-mail address which will be shown in Devise::Mailer,
  # note that it will be overwritten if you use your own mailer class
  # with default "from" parameter.
  config.mailer_sender = 'aruru.services@gmail.com'
  ...
  # config.pepper = '09d7fe7884c2df779aefafef65a4b6626457d74598d9c819f6006970d7da88217ff107350e5ecd8164ef9c2f51a1f3aaf1dbe195c59ccc9035ae2e5c9ad8718e'
  ...
  config.omniauth :square,
    ...
    Rails.application.secrets.square_secret_key,
    {
      ...
      :client_options => {
        :connect_site => Rails.configuration.x.env.production? ? 'https://connect.squareup.com' : 'https://connect.squareupsandbox.com',
        :site => Rails.configuration.x.env.production? ? 'https://squareup.com' : 'https://squareupsandbox.com'
      }
    }
end
